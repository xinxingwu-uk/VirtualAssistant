...
This project demonstrates how to create **AI-generated talking images** for course slides by combining **OpenVoice** (speech generation, [Link](https://github.com/myshell-ai/OpenVoice)) and **Ditto-TalkingHead** (audio-driven facial animation, [Link](https://github.com/antgroup/ditto-talkinghead)).  
